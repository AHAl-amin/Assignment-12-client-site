...
// ......................
    ...
    const navlinks = <>
        ...
        <li><NavLink to="/alltrainer" className='font-semibold'> All Trainer </NavLink></li>
        <li><NavLink to="/allclasses" className='font-semibold'> All Classes </NavLink></li>
        <li><NavLink to="/community" className='font-semibold'> Community </NavLink></li>
        
                       
        {
            user && <>
            <li><NavLink to="/dashboard/dashboardPage" className='font-semibold'> Dashboard </NavLink></li>
    ...
    return (
        <div className="navbar bg-base-100 max-w-6xl mx-auto">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost md:text-3xl text-[16px] font-bold text-orange-400" >FitnessPal</a>
